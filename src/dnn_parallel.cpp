                           ...
                           bool verbose = false)
{
    ...
    for (int i = 0; i < B; i++)
    {
        ...
        arma::vec reg_est = tdnn(X_boot, Y_boot, X_test,
                                 c, n_prop, M, W0);
                        ...
                        bool verbose = false)
{
    ...
    for (int i = 0; i < B; i++)
    {
        ...
        // TO-DO: Change to have separate c and M for treatment and control group?
        arma::vec trt_est = tdnn(X_trt_boot, Y_trt_boot, X_test,
                                 c, n_prop, M, W0);

        arma::vec ctl_est = tdnn(X_ctl_boot, Y_ctl_boot, X_test,
                                 c, n_prop, M, W0);
