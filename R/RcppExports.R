...
bootstrap_cpp_mt <- function(X, Y, X_test, c, n_prop, M, B, W0_) {
    .Call(`_tdnn_bootstrap_cpp_mt`, X, Y, X_test, c, n_prop, M, B, W0_)
}

bootstrap_trt_effect_cpp_mt <- function(X, Y, W, X_test, s_choice_trt, s_choice_ctl, c, n_prop, M, B, W0_ = NULL) {
    .Call(`_tdnn_bootstrap_trt_effect_cpp_mt`, X, Y, W, X_test, s_choice_trt, s_choice_ctl, c, n_prop, M, B, W0_)
}
...
tdnn <- function(X, Y, X_test, c, n_prop, M, W0_) {
    .Call(`_tdnn_tdnn`, X, Y, X_test, c, n_prop, M, W0_)
}
...
bootstrap_cpp <- function(X, Y, W, X_test, s_choice_0, s_choice_1, c, n_prop, M, W_0 = NULL, B = 1000L, verbose = FALSE) {
    .Call(`_tdnn_bootstrap_cpp`, X, Y, W, X_test, s_choice_0, s_choice_1, c, n_prop, M, W_0, B, verbose)
}

est_reg_fn_mt_rcpp <- function(X, Y, X_test, c, n_prop, M, verbose = FALSE, old = FALSE, W0_ = NULL) {
    .Call(`_tdnn_est_reg_fn_mt_rcpp`, X, Y, X_test, c, n_prop, M, verbose, old, W0_)
}
...
tdnn_reg_cpp <- function(X, Y, X_test, c, M, n_prop, bootstrap_iter, estimate_variance, verbose, W0_) {
    .Call(`_tdnn_tdnn_reg_cpp`, X, Y, X_test, c, M, n_prop, bootstrap_iter, estimate_variance, verbose, W0_)
}
...
make_param_estimate <- function(X_train, Y_train, X_val, ordered_Y, ord_arma, n, p, log_n, c, M, n_prop, W0) {
    .Call(`_tdnn_make_param_estimate`, X_train, Y_train, X_val, ordered_Y, ord_arma, n, p, log_n, c, M, n_prop, W0)
}
